...
## 20230901起，不再提供手工导入的方式，改由直接从表里查
...
where 1>2;
 ...
 -- 七月的数据  需要建一张七月的表  dwd_d_evt_cb_trade_his_202307这张表没建过
...
```mysql
--建一张智家个人信息表6月  join了dwd_d_evt_cb_trade_his_202306 六月的cb表
...
-- 向智家个人信息表7月中注入数据 join了dwd_d_evt_cb_trade_his_202306 六月的cb表
...
联通app业务办理成功率 7-8    分子 分母 

联通app整体满意度 7-8 分子 分母 

联通app页面平均响应时长 7-8 分子 分母 
