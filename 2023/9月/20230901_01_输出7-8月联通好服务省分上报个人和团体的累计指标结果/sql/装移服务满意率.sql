...
where substr(a.dt_id,0,6)='202307' or substr(a.dt_id,0,6)='202308' and 1>2;

insert overwrite table dc_dwd.dwd_d_evt_zj_zyfw_person_calculate_detail_20230708
select
    b.prov_name,
    b.xm,
    b.staff_code,
...
select * from dc_dwd.dwd_d_evt_zj_zyfw_person_calculate_detail_20230708 limit 10;
...
insert overwrite table dc_dwd.dwd_d_evt_zj_zyfw_team_calculate_detail_20230708
select
    b.prov_name,
    b.xm,
    b.staff_code,
...
select  case when fenzi is not null  then 1 else 0 end  as fenzi,
 ...
 o_a.staff_code=o_b.staff_code where o_b.prov_name = o_a.prov_name or o_a.xm = o_b.xm
)
a
