create table xkfpc.lz_gold_silver_202308_1 as
select  
sheet_id                         ,
sheet_no                         ,
sheet_type                       ,
...
case 
 ...
 when regexp(upper(serv_content),'视频名片')=true then '5G视频名片'
...
from dc_dwa.dwa_d_sheet_main_history_chinese 
 ...
 and ( 
 regexp(upper(serv_content),'乐铃|彩铃|铃声|铃音|炫铃|助理|来电名片|漏话提醒|挂机短信|语音留言|智能应答|反诈名片|数字名片|云盘|联通看家|神眼|沃家云视|组网|FTTR|全屋光宽带|全屋光纤|全屋WIFI|智慧到家|联通超清|IPTV|视频名片|5G消息')=true 
  or 
...
select sheet_pro_name,
       ...
       month_id,
       '投诉'
from xkfpc.lz_gold_silver_202307 tb1
