drop table dc_dwd.temp_1007;
create table dc_dwd.temp_1007
(
    ...
    location 'hdfs://beh/user/dc_dwd/dc_dwd.db/temp_1007';
-- hdfs dfs -put /home/dc_dw/test1_xdc.csv /user/dc_dw
load data inpath '/user/dc_dw/test1_xdc.csv' overwrite into table dc_dwd.temp_1007;
select *
from dc_dwd.temp_1007;
drop table dc_dwd.temp_1008;
create table dc_dwd.temp_1008
(
    zb_id       string comment '指标id',
    nation      string comment '全国',
    beijing     string,
    ...
    location 'hdfs://beh/user/dc_dwd/dc_dwd.db/temp_1008';
select *
from dc_dwd.temp_1008;
-- hdfs dfs -put /home/dc_dw/test2_xdc.csv /user/dc_dw
load data inpath '/user/dc_dw/test2_xdc.csv' overwrite into table dc_dwd.temp_1008;
