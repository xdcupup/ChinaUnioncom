...
drop table dc_dwd.lz_gold_silver;
create table dc_dwd.lz_gold_silver as
select sheet_id,
       sheet_no,
       sheet_type,
       ...
       case
 when regexp(upper(serv_content),'FTTR|全屋光宽带|全屋光纤')=true then '联通组网'
end product_type,
...
where month_id in ('202301','202302','202303','202304','202305','202306','202307','202308','202309')--1-9
  and
    regexp(upper(serv_content),'FTTR|全屋光宽带|全屋光纤')= true
...
select sheet_pro_name,
       ...
       month_id,
       '投诉'
from dc_dwd.lz_gold_silver tb1
