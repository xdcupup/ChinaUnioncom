...
create table db1.no_standards_0201_0221
with t1 as (select 省份,
                   ...
                   指标值,
                   账期
            from db1.xzdrh_0201_0221_tongji),
     t2 as (select 省份,
                   市,
                   区,
                   班组,
                   ...
                   指标值,
                   账期
            from db1.zjdrt_0201_0221_tongji)
select t1.省份,
       t1.市,
       t1.区,
       t1.班组,
...
-- 创建 统计总表上周
drop table db1.all_0201_0221;
create table db1.all_0201_0221
with t1 as (select 省份,
                   市,
                   区,
                   班组,
