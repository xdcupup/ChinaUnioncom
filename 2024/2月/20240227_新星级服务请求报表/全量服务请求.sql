...
select * from dc_dwa.dwa_d_sheet_main_history_chinese where month_id = '202402' and day_id = '29' limit 10;
select service_type_name, star_level, dt_id, bus_pro_id, service_no
      from dc_dm.dm_d_callin_sheet_contact_agent_report where dt_id = '20240228' limit 10;
-- todo 星级评定规则服务请求量-不满
...
with t1 as (select service_type_name, dt_id, bus_pro_id, service_no, meaning
     ...
     t2 as (select serv_content, busi_no
            ...
            where (
                      (month_id = '202402' and day_id >= '01') and   (month_id = '202402' and day_id <= '25')
                      )),
...
select real_ind_fam_level, vip_class_id
