...
where one_answer in ('1', '7')
  and concat(month_id, day_id) >= '20240115'
  and concat(month_id, day_id) <= '20240214' ;
...
from dc_dwd.dwd_d_nps_satisfac_details_broadband_repair
where
concat(month_id, day_id) >= '20240115'
  and concat(month_id, day_id) <= '20240214' and handle_province_name is null  group by concat(month_id, day_id) ;
...
where one_answer in ('1', '7')
  and concat(month_id, day_id) >= '20240115'
  and concat(month_id, day_id) <= '20240214' and handle_province_name is null