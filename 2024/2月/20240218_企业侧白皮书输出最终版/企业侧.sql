...
select pro_name, index_name, index_code, index_value_numerator, index_value_denominator, index_value, monthid
from dc_dm.dm_service_standard_enterprise_index
where monthid = '202402';


select pro_name, index_name, kpi_code, index_value_numerator, index_value_denominator, index_value
from dc_dwd.dwd_service_standard_enterprise_index;
-- on t1.index_name = t3.index_name and t2.pro_name = t3.pro_name and t2.monthid = t3.month_id;
...
with t1 as (select index_name, b.meaning as pro_name
     ...
     t3 as (select pro_name, index_name, kpi_code, index_value_numerator, index_value_denominator, index_value, month_id
            from dc_dwd.dwd_service_standard_enterprise_index),
     -- t4 报表数据
...
select * from dc_dwd.dwd_d_enterprise_final_bb;
-- 链接分类 给省份排序
