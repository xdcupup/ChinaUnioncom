...
from (select pro_name,                                                       --省份名称
             ...
             'FWBZ027'                           as kpi_code,                --指标编码
             '互联网专线三日开通率'              as index_name,              --五级-指标项名称
...
from (select meaning                            as pro_name,                --省份名称
             ...
             '交付开通'                         as index_level_3,           --指标级别三
             '业务限时交付'                     as index_level_4,           -- 指标级别四
             'FWBZ054'                          as kpi_code,                --指标编码
             '省内点对点专线五日开通率'         as index_name,              --五级-指标项名称
             '≥'                                as standard_rule,           --达标规则
             '0.9'                              as traget_value_nation,     --目标值全国
             '0.9'                              as traget_value_pro,        --目标值省份
             ...
             round(kpi_value, 6)                as index_value
      from (select pro_id,
                   if(pro_id = '00', '全国', meaning) as meaning,
                   city_id,
                   kpi_id,
                   kpi_value,
                   index_value_type,
