                     ...
                     right join (select a.*
                                 ...
                                 where date_id rlike '${v_month_id}'
                                   ...
                                   and trade_type_code in
                                       ('10', '268', '269', '269', '270', '270', '271', '272', '272', '272', '273',
                                        '273', '274',
                                        '274', '275',
            ...
            where rn = 1) t2
               right join (select a.*
                           ...
                           where date_id rlike '${v_month_id}'
                             and net_type_code = '40'
                             and trade_type_code in
                                 ('10', '268', '269', '269', '270', '270', '271', '272', '272', '272', '273', '273',
                                  '274',
                                  '274', '275',
                                  '276', '276', '276', '277', '3410')
                             and cancel_tag not in ('3', '4')
...
from dc_dwd_cbss.dwd_d_tf_bh_trade_all_dist
where date_id = '20240101';
select unix_timestamp(fitst_time), fitst_time
from dc_dwd.omi_zhijia_time_202401;
