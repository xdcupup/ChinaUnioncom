...
# 查询语句3
query3 = f"select t2.* from (select * from {no_standars_value} where 市 = '{area}' or 市 = '{area2}') t1  join {zj_mingxi} t2 on t1.工号 = t2.工号;"
df3 = pd.read_sql(query3, connection)

# 查询语句4
query4 = f"select t2.* from (select * from {no_standars_value} where 市 = '{area}' or 市 = '{area2}') t1 join {xz_mingxi} t2 on t1.工号 = t2.工号;"
...
writer = pd.ExcelWriter(f'C:/Users/14659/Desktop/预警工单数据/2月/{dt2}/陕西/{area}地市{dt2}预警信息.xlsx')
