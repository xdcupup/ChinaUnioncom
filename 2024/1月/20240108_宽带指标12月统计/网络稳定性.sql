...
select province_code as HANDLE_PROVINCE_CODE,
       ...
       sum(
               case
                   when locate("网络稳定性", answer_3) > 0
                       or locate("网络稳定性", answer_4) > 0
                       or locate("网络稳定性", answer_2) > 0 then answer_1
                   else 0
                   end
       )                total_source,
       sum(
               case
                   when answer_1 >= 1
                       and answer_1 <= 6
                       and locate("网络稳定性", answer_2) > 0 then 1
                   else 0
                   end
       )                bad_one_scene,
       sum(
               case
                   when answer_1 >= 7
                       and answer_1 <= 8
                       and (
                            locate("网络稳定性", answer_3) > 0
                                or locate("网络稳定性", answer_2) > 0
                            ) then 1
                   else 0
                   end
       )                center_one_scene,
