...
-- hdfs dfs -put /home/dc_dw/xdc_data/person_202403.csv /user/dc_dw
-- todo 将数据导入到HDFS上
load data inpath '/user/dc_dw/person_202403.csv' overwrite into table dc_dwd.person_2024 partition (month_id = 202403);
select *
...
-- hdfs dfs -put /home/dc_dw/xdc_data/team_202403.csv /user/dc_dw
-- todo 将数据导入到HDFS上
load data inpath '/user/dc_dw/team_202403.csv' overwrite into table dc_dwd.team_2024 partition (month_id = 202403);
select *
