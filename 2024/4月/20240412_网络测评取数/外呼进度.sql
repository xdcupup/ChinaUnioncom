...
where month_id = '202404'
  and day_id = '11'
  and a.UPD_TIME > '2024-04-11 05:00:00'
  and a.UPD_TIME < '2024-04-12 00:00:00'
  and task_id in (
...
select count(if(status != '1', 1, null)) as cnt,
       ...
       day_id
from dc_dwd.dwd_d_crm_marketing_info_new a
where month_id in ('202404', '202403')
  and task_id in (
                  '2d28f6d801a449e5be4ea6100537bc7b',
                  'ad7c7e103f4d4349ae4355cc08c7672d',
                  '0da0b62bb0dc43ba93545c1dba90fff7',
...
group by task_id, month_id, day_id;