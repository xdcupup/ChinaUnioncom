...
set hive.mapred.mode = nonstrict;
set mapreduce.job.queuename = q_dc_dw;
create table dc_dwd.leiji_xdc_0411 as
select *
from dc_dwd.ywcp_mx_temp_all
union all
select *
from dc_Dwd.ywcp_mx_temp;
...
create table dc_dwd.leiji_xdc_yiyuan as -- 加齐鲁医院  28593732463776
select *
from dc_dwd.leiji_xdc_0411
union all
select *
from dc_Dwd.ywcp_mx_temp;
...
select *
from dc_Dwd.ywcp_mx_temp_guangchang; ---泰盛广场2期


create table dc_dwd.leiji_xdc_guangchang as
select *
from dc_dwd.leiji_xdc_yiyuan
union all
select *
from dc_Dwd.ywcp_mx_temp;
--  "29035462203552",  -- 仓山市民服务中心
--  '28733138747552',  -- 中海环宇城购物中心
--  '29035465592992',  -- 麦德龙(淄博张店商场)
--  '29035465449120'  -- 雅侎之星购物中心
select *
from dc_Dwd.ywcp_mx_temp_4sc;
select *
from dc_Dwd.ywcp_mx_temp_vdl; -- 维多利广场\


select * from dc_dwd.leiji_xdc_guangchang
union all
select *
from dc_Dwd.ywcp_mx_temp_4sc
union all
select *
from dc_Dwd.ywcp_mx_temp_vdl;
