...
where month_id in ('202404', '202403')
  and a.UPD_TIME > '2024-03-20 05:00:00'
  ...
  and task_id in (
                  ...
                  '51a410832a8a49f7afeff17dfb0692cf', --24日居民住宅     28355620440224
...
where month_id in ( '202403')
  ...
  and task_id in ('14906103e3254924b4dd75153b906289') group by task_id;