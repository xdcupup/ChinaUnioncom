...
where keyno is not null and rn1 > ;
...
where scen_type not in ('商务楼宇及酒店', '商务楼宇', '酒店', '居民住宅', '住宅小区');
...
-- 43047 重复手机号  -- 92463条重复数据
select *
from (select  *,row_number() over (partition by serial_number)  as rn
