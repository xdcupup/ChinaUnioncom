...
-- hdfs dfs -put /home/dc_dw/xdc_data/357_202405.csv /user/dc_dw
load data inpath '/user/dc_dw/357_202405.csv' overwrite into table dc_dm.dm_service_standard_enterprise_index partition (monthid = '202405',index_code ='357');
insert overwrite table dc_dm.dm_service_standard_enterprise_index partition (monthid = '${v_month_id}', index_code = '357')
;
...
load data inpath '/user/dc_dw/level_202405.csv' overwrite into table dc_dwd.dwd_service_standard_enterprise_level;
select *
