...
insert overwrite table dc_dm.dm_service_standard_enterprise_index partition (monthid = '${v_month_id}', index_code = '10010qlgdjjl')
select pro_name,
       area_name,
       index_level_1,
       index_level_2_big,
...
from (select meaning                                                        as pro_name,                --省份名称
             ...
             '--'                                                           as kpi_code,                --指标编码
             '10010-全量工单解决率'                                   as index_name,              --五级-指标项名称
