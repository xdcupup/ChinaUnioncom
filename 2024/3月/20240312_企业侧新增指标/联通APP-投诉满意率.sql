...
-- 指报告期内电子渠道投诉工单评价满意样本量与电子渠道投诉工单满意情况参评样本量、电子渠道投诉工单单次未推测样本量的比值。
-- 联通APP-投诉满意率=电子渠道投诉工单评价满意样本量/（电子渠道投诉工单满意情况参评样本量+电子渠道投诉工单单次未推测样本量）*100%
-- 现有报表路径：客服运营平台-洞察分析-统一报表-【稽核后】高品质服务满意度月报；筛选规则：专业线：渠道服务；大类问题：手网短微等电子渠道；全量小类问题：不限。

select meaning, manyi as fz, manyi_cp + is_novisit_cnt as fm
...
insert overwrite table dc_dm.dm_service_standard_enterprise_index partition (monthid = '${v_month_id}', index_code = 'ltapptsmyl')
select pro_name,
       area_name,
       index_level_1,
       index_level_2_big,
