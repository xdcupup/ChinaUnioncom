...
from (select count(id)        mention,
      ...
      from (select *,
            ...
            where substr(date_par, 0, 6) = '${v_month_id}') a
      where rn = 1
...
insert overwrite table dc_dm.dm_service_standard_enterprise_index partition (monthid = '${v_month_id}', index_code = 'ltappztmyd')
select pro_name,
       area_name,
       index_level_1,
       index_level_2_big,
