...
-- 指报告期内电子渠道投诉工单评价及时响应样本量与电子渠道投诉工单响应情况参评样本量、电子渠道投诉工单单次未推测样本量之和的比值。
-- 联通APP-投诉响应率=电子渠道投诉工单评价及时响应样本量/（电子渠道投诉工单响应情况参评样本量+电子渠道投诉工单单次未推测样本量）*100%
...
insert overwrite table dc_dm.dm_service_standard_enterprise_index partition (monthid = '${v_month_id}', index_code = 'ltapptsxyl')
select pro_name,
       area_name,
       index_level_1,
       index_level_2_big,
